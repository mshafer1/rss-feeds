...
def main(feeds: typing.Tuple[str, ...], output_json: bool, out_dir: pathlib.Path, cache_dir: pathlib.Path, items_path: str):
    cache_dir.mkdir(parents=True, exist_ok=True)
    out_dir.mkdir(parents=True, exist_ok=True)

    for feed in feeds:
        data = rss_retriever.fetch_feed(uri=feed, return_json=output_json, cache_dir=cache_dir, items_path=items_path)
